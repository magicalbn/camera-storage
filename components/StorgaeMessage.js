...
const StorgaeMessage = () => {
    return (
        <div className="absolute bg-[#1e1e1e] text-white top-[47%] left-[50%]  rounded-[1rem] max-w-[600px] w-[75vw] translate-y-[-50%] translate-x-[-50%] z-50">
            ...
            <div className="flex border-t border-[#373737]">
                ...
                <div className="flex-1 h-12 flex justify-center items-center">
                    <p className="flex-1 text-center text-[#6596d4] font-bold">
                        Manage
                    </p>
                </div>
            </div>
